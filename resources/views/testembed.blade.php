...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="{{asset('styleapi/css/embed.css')}}" />
		<link rel="stylesheet" type="text/css" href="{{asset('styleapi/css/leaflet.css')}}" />

		<script type="text/javascript" src="{{asset('styleapi/js/leaflet.js')}}"></script>
		<script type="text/javascript" src="{{asset('styleapi/js/L.TileLayer.Grayscale.js')}}"></script>
		
		<script type="text/javascript" src="{{asset('styleapi/js/startposition.js')}}"></script>
		<script type="text/javascript" src="{{asset('styleapi/js/functions.js')}}"></script>
		<script type="text/javascript" src="{{asset('styleapi/js/bitmap-map.js')}}"></script>
	</head>
